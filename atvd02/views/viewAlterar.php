...
<body>
    <div class="container py-4">
        <form class="form" method="post" action="viewAlterar.php">
            ...
            <h3 class="display-7 text-secondary"><b>Alterar Pessoa Fisica</b></h3>
            <div class="row">
                <div class="col">
            ...
            <div class="row">
                <div class="col">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" name="endereco" placeholder="Endereco" value="<?php echo $_GET['endereco']; ?>" />
